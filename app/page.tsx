    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 bg-pattern bg-grid">
      <div className="max-w-2xl mx-auto px-6 py-12 relative">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-zinc-300 mb-8 leading-relaxed font-body">
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-4">
            <p className="text-zinc-300 font-body">
              <span className="text-zinc-100 font-medium">Efficient Inference:</span> Understanding how to serve large models quicker and more efficiently.
            </p>
            <p className="text-zinc-300 font-body">
              <span className="text-zinc-100 font-medium">ML for Games:</span> Researching techniques for improving the performance of ML in games with a particular interest in poker.
            </p>
            <p className="text-zinc-300 font-body">
              <span className="text-zinc-100 font-medium">Geometric ML:</span> Using geometric ML to solve problems in healthcare and push forward the <Link href="https://arxiv.org/abs/2309.08630" className="text-zinc-300 hover:text-zinc-100 transition-colors underline">SoTA in particle jet tagging</Link>.
            </p>
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" className="hover:text-zinc-300" asChild>
